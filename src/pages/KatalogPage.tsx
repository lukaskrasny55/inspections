  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900">
      <header className="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 px-6 py-4">
        ...
        <h1 className="text-xl font-semibold text-slate-900 dark:text-slate-50 mt-1">Katalóg</h1>

        <div className="flex gap-1 mt-4">
          <button
            onClick={() => selectView('checklist')}
            className={`px-4 py-2 text-sm font-medium rounded-md ${
              view === 'checklist' ? 'bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700'
            }`}
          >
            Checklist
          </button>
          <button
            ...
            className={`px-4 py-2 text-sm font-medium rounded-md ${
              view === 'technicke-riesenie' ? 'bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700'
            }`}
          >
            Technické riešenie
          </button>
